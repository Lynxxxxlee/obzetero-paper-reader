...
| Zotero tag | Meaning |
| --- | --- |
| 待阅读 or /待阅读 | Prepare this paper for automatic Chinese intensive-reading notes |
...
- `待阅读` is not a reading status. It is a work-queue tag that controls whether `read` prepares a paper for Chinese intensive reading.
